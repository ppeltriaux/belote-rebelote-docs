# belote-rebelote-docs

Public documents for the **Belote et Rebelote** iOS app.

## Documents

- [Privacy Policy](./PRIVACY.md) — what data the app collects, where it goes, and how to control it.
